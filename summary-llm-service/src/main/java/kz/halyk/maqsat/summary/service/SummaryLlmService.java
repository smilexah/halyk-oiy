...
import kz.halyk.maqsat.summary.exception.AiResponseException;
...
public class SummaryLlmService {
    ...
    public SummaryLlmService(OpenAiProperties props, OpenAiClient openAi, ObjectMapper mapper, MeterRegistry meterRegistry) {
        this.props = props;
        this.openAi = openAi;
        this.mapper = mapper;
    ...
    public SummaryResult summarise(String userId, String period, String language,
        ...
        if (!props.enabled()) {
            ...
            SummaryResult r = fallback(userId, period, language, metrics);
    ...
    private SummaryResult fallback(String userId, String period, String language, UserMetricsDto m) {
