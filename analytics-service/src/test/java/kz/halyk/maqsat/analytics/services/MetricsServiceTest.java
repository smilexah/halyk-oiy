...
import kz.halyk.maqsat.analytics.services.impl.DriftServiceImpl;
import kz.halyk.maqsat.analytics.services.impl.MetricsServiceImpl;
...
@DataJpaTest
@ActiveProfiles("test")
@Import({MetricsServiceImpl.class, DriftServiceImpl.class})
class MetricsServiceTest {
    ...
    void recurringDetection_threeMatchingAmountsOnDistinctDays() {
        ...
        assertThat(recurring.get(0).getAmount()).isEqualByComparingTo(new BigDecimal("990.00"));
        assertThat(recurring.get(0).getConfidence()).isLessThanOrEqualTo(BigDecimal.ONE);
    }
    ...
    void driftDetection_overBudgetByThirtyPercent() {
        ...
        assertThat(report.getDriftByCategory().get("Продукты")).isEqualByComparingTo(new BigDecimal("0.3000"));
