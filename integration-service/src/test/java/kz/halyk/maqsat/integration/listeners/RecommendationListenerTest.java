...
class RecommendationListenerTest {
    ...
    @Mock HalykTravelClient halykTravelClient;
    @InjectMocks RecommendationListener listener;
    ...
    void routesAlserAndTravelOffersToCorrectClients() {
        ...
        listener.onRecommendation(new RecommendationReady(
                userId, "2026-05",
                List.of(
                        new RecommendationReady.MatchedOffer(alserOfferId, "ALSER", new BigDecimal("0.850"),
                                List.of("electronics-saver", "apple-fan"), "high overlap"),
                        new RecommendationReady.MatchedOffer(travelOfferId, "HALYK_TRAVEL", new BigDecimal("0.720"),
                                List.of("saving_for_trip", "beach-lover"), "saving goal matched")
                ), Instant.now()));
