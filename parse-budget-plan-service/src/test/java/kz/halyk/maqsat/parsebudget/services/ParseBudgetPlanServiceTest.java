...
import kz.halyk.maqsat.parsebudget.services.impl.ParseBudgetPlanServiceImpl;
...
class ParseBudgetPlanServiceTest {
    ...
    @InjectMocks
    private ParseBudgetPlanServiceImpl service;
    ...
    void emptyCategories_throwsInvalidPlanException() {
        ReplanRequest req = new ReplanRequest("user-1", "2026-05",
                new BudgetPlanProposal(List.of(), "rationale"), null);
