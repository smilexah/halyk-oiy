package kz.halyk.maqsat.parsebudget.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleInvalidPlan(InvalidPlanException ex, HttpServletRequest req) {
    ...
    public ResponseEntity<ApiError> handleGeneral(Exception ex, HttpServletRequest req) {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ApiError.of(HttpStatus.INTERNAL_SERVER_ERROR.value(), "Internal Server Error", ex.getMessage(), req.getRequestURI()));
    }
}
